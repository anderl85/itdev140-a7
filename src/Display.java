...
public class Display {
	...
	public Display(String[] assignments, String t){
		...
		//top left display 2: -1920, 4  formerly
	...
	private void createMenu(String[] assignments){
		...
		menu = new JOptionPane("Pick One", JOptionPane.PLAIN_MESSAGE, JOptionPane.DEFAULT_OPTION, null, assignments);
	...
	public String showInputLimited(String message, String[] options){
		String retval;
		frame.setVisible(true);
		Object result = JOptionPane.showInputDialog(frame, message, title, JOptionPane.PLAIN_MESSAGE, null, options, options[0]);
		retval = result.toString();
		frame.setVisible(false);
		return retval;
	}
	
	public String showInputOpen(String message){
		String retval;
		frame.setVisible(true);
		retval = JOptionPane.showInputDialog(frame, message, title, JOptionPane.PLAIN_MESSAGE);
		frame.setVisible(false);
		return retval;
	}
